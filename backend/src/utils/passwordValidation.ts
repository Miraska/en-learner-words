...
export class PasswordValidator {
    ...
    private static readonly REQUIRE_UPPERCASE = false; // Not required, just adds to strength
    private static readonly REQUIRE_LOWERCASE = false; // Not required, just adds to strength
    private static readonly REQUIRE_NUMBERS = true;
    private static readonly REQUIRE_SPECIAL_CHARS = false; // Simplified - no special chars required
